...
alias lief='~/wfautomation/scripts/sdmmc_install_edgeai_quick.sh /media/rishikesh ~/ti-linux-kernel/build'
...
alias liefr='~/wfautomation/scripts/sdmmc_install_edgeai_quick.sh /media/rishikesh ~/ti-linux-kernel/build && rb'
